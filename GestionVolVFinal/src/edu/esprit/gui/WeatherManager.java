...
public class WeatherManager {
    ...
    public void getWeather(){
        ...
        try {
           // json = readJsonFromUrl("http://api.openweathermap.org/data/2.5/weather?q="+city+"&appid={e01b86a640eb593f6c28bac29ff5c400}&lang=eng&units=metric");
           json = readJsonFromUrl("http://api.openweathermap.org/data/2.5/weather?q="+city+"&APPID=e01b86a640eb593f6c28bac29ff5c400&cnt=16&units=metric");
            //json = readJsonFromUrl("http://api.openweathermap.org/data/2.5/weather?id=1271631&APPID=e01b86a640eb593f6c28bac29ff5c400&cnt=16&units=metric");
        } catch (IOException e) {
            return;
        }
