...
import static edu.esprit.gui.TestMapController.map_value;
...
public class WebViewCaptureMap {
    ...
    public void start(Stage stage) throws Exception {
        ...
        TestMapController tmc = new TestMapController();
        webEngine.setOnAlert(event -> tmc.showAlert(event.getData()));
