...
public class Resetmail {
   ...
   public void resetpass(String code,String mail) {    
...
"																<h1 style='margin: 0; color: #101010; font-size: 27px; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; line-height: 120%; text-align: center; direction: ltr; font-weight: normal; letter-spacing: normal; margin-top: 0; margin-bottom: 0;'><strong>Forgot Your Password?</strong></h1>\n" +
"															</td>\n" +
"														</tr>\n" +
"													</table>\n" +
"												</td>\n" +
