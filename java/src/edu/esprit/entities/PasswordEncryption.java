...
{  
    private static String finalsalt = "1jwhOcGNEGRTxHm7PmLSD7Yak0gnwe";
    /* Driver Code */  
    ...
    public static String generatehash(String password){
        return PassBasedEnc.generateSecurePassword(password, finalsalt);  
    }
    public static boolean checkpassword(String password,String encrypted){
        return PassBasedEnc.verifyUserPassword(password,encrypted,finalsalt);  
    }
}  
